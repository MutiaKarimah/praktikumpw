...
$sql = "SELECT * FROM tb_barang WHERE idgame=$idgame";
    ...
    {		
		...
		<div class="container">	
		 <h2 class="title"><span>Tambah Game</span></h2>	  			
				<form method="post" name="" action="proses_edit.php">
<table border=0 align="center" cellpadding=5 cellspacing=0>
<tr>
<td colspan=3><center><font size=5>Input Data Penjualan</font></center></td>
</tr>
<tr>
<td>ID Game</td><td>:</td><td><input type="text" name="idgame" value="<?php echo $data['idgame'] ?>"></td>
</tr>
<tr>
<td>Nama Game</td><td>:</td><td><input type="text" name="namagame" value="<?php echo $data['namagame'] ?>"></td>
</tr>
<tr>
<td>Tanggal Rilis</td><td>:</td><td><input type="date" name="tglrilis" value="<?php echo $data['tglrilis'] ?>"></td>
</tr>
<tr>
<td>Versi Game</td><td>:</td><td><input type="text" name="versi" value="<?php echo $data['versi'] ?>"></td>
</tr>
<tr>
<td>Genre</td><td>:</td><td><input type="text" name="genre" value="<?php echo $data['genre'] ?>"></td>
</tr>
<tr>
<td>Isi Paket</td><td>:</td><td><input type="text" name="isipaket" value="<?php echo $data['isipaket'] ?>"></td>
</tr>
<tr>
<td>Harga Paket</td><td>:</td><td><input type="text" name="harga" value="<?php echo $data['harga'] ?>"></td>
</tr>
<tr>
